...
function ModalForCards({ item, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 overflow-y-auto max-h-[80vh] relative"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          className="absolute top-2 right-2 hover:text-gray-900 text-xl font-semibold text-red-700"
          onClick={onClose}
        >
          ✕
        </button>
